...
open_file = open("picked_algos/originalnaivebayes5k.pickle","rb")
...
##########
open_file = open("picked_algos/BernoulliNB_classifier5k.pickle","rb")
...
###############
open_file = open("picked_algos/SGD_classifier5k.pickle","rb")
